...
const Projects = () => {
  return (
    <section className="min-h-screen mt-10 pb-8" data-aos="fade-up">
      <h1 className="text-left text-3xl lg:text-4xl font-bold pb-3 animate__animated animate__slideInDown">Projects</h1>
      
      <section className="grid lg:grid-cols-3 grid-cols-1 justify-center mt-4 mx-auto w-11/12 gap-y-6 items-center gap-3">
